...
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default"
    data-assets-path="<?= base_url('assets/login'); ?>/" data-template="R17 Group">
...
<head>
    ...
    <title>Portal - Bagiyo Denso</title>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/login'); ?>/assets/vendor/css/core.css"
        class="template-customizer-core-css" />
    <link rel="stylesheet" href="<?= base_url('assets/login'); ?>/assets/vendor/css/theme-default.css"
        class="template-customizer-theme-css" />
    <link rel="stylesheet" href="<?= base_url('assets/login'); ?>/assets/css/demo.css" />

    <link rel="stylesheet"
        href="<?= base_url('assets/login'); ?>/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css" />
