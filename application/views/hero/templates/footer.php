...
<div class="container-fluid bg-dark text-light footer pt-5 mt-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container py-5">
        <div class="row g-5">
            <?php foreach ($cabang_list as $cb): ?>
                <div class="col-lg-3 col-md-6">
                    <h4 class="text-light mb-4">Alamat <?= $cb['name']; ?></h4>

                    <p class="mb-2">
                        <i class="fa fa-map-marker-alt me-3"></i><?= $cb['alamat']; ?>
                    </p>

                    <p class="mb-2">
                        <i class="fa fa-phone-alt me-3"></i><?= $cb['phone']; ?>
                    </p>

                    <p class="mb-2">
                        <i class="fa fa-envelope me-3"></i><?= $cb['email']; ?>
                    </p>

                    <div class="d-flex pt-2">
                        <?php if (!empty($cb['instagram'])): ?>
                            <a class="btn btn-outline-light btn-social" target="_blank" href="https://instagram.com/<?= $cb['instagram']; ?>">
                                <i class="fab fa-instagram"></i>
                            </a>
                        <?php endif; ?>

                        <?php if (!empty($cb['youtube'])): ?>
                            <a class="btn btn-outline-light btn-social" target="_blank" href="https://youtube.com/<?= $cb['youtube']; ?>">
                                <i class="fab fa-youtube"></i>
                            </a>
                        <?php endif; ?>

                        <?php if (!empty($cb['tiktok'])): ?>
                            <a class="btn btn-outline-light btn-social" target="_blank" href="https://tiktok.com/<?= $cb['tiktok']; ?>">
                                <i class="fab fa-tiktok"></i>
                            </a>
                        <?php endif; ?>

                        <?php if (!empty($cb['facebook'])): ?>
                            <a class="btn btn-outline-light btn-social" target="_blank" href="https://facebook.com/<?= $cb['facebook']; ?>">
            ...
            <div class="col-lg-3 col-md-6">
                <h4 class="text-light mb-4">Site Maps</h4>
                <a class="btn btn-link" href="<?= base_url('tentang'); ?>">Tentang Kami</a>
                <a class="btn btn-link" href="<?= base_url('layanan'); ?>">Layanan</a>
                <a class="btn btn-link" href="<?= base_url('cabang'); ?>">Cabang</a>
                <a class="btn btn-link" href="<?= base_url('artikel'); ?>">Artikel</a>
            </div>
        </div>
    </div>
    <div class="container">
