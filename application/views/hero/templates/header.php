...
<body>
    ...
    <div class="container-fluid bg-light p-0">
        <div class="row gx-0 d-none d-lg-flex">
            ...
            <div class="col-lg-6 pb-3 text-end">
                <div class="h-100 d-inline-flex flex-column me-4">
                    ...
                    <div class="d-inline-flex align-items-center mb-2">
                        <small class="fa fa-map-marker-alt text-primary me-2"></small>
                        <small>Jl. Raya Kudus- Jepara No. 519 (Pertigaan RSI Sunan Kudus)</small>
                    </div>
                </div>
                <div class="h-100 d-inline-flex flex-column align-items-end py-3 me-4">
                    <div class="d-inline-flex align-items-center mb-2">
