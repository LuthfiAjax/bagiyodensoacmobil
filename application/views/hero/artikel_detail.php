...
<!-- Page Header Start -->
<div class="container-fluid page-header mb-5 py-4 px-0"
    style="background-image: url(<?= base_url('assets/img/about.jpg'); ?>);">

    <div class="container-fluid page-header-inner py-5">
        <div class="container text-center">
            <h1 class="display-3 fs-1 text-white mb-3 animated slideInDown">
                <?= $articles->title_article_id; ?>
            </h1>
