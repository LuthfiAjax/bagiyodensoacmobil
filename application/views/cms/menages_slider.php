            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a class="btn btn-sm btn-primary mb-3" href="<?= base_url('cms/create-slider'); ?>">
                                ...
                                <tbody>
                                    ...
                                    foreach ($sliders as $row) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?= $row['position_order']; ?></td>
                                            <td class="text-center">
                                                <div class="dropdown float-right">
                                                    ...
                                                    <div class="user-menu dropdown-menu">
                                                        <a class="nav-link" href="<?= base_url('cms/update-slider/' . $row['id']); ?>">
...
<script>
    function deleteSlider(id) {
        const confirmDelete = confirm('Konfirmasi. Slide yang dihapus akan hilang selamanya, Anda yakin ?');
        if (!confirmDelete) return;

        fetch(`<?= base_url('cms/api/delete/slider/'); ?>${id}`, {
                method: 'GET'
            })
            .then(response => {
                if (response.ok) {
