...
class Api extends CI_Controller
{
    ...
    public function cek_promo($id)
    {
        ...
        // Ambil promo terbaru yang aktif & masih dalam periode
        ...
        $promo = $this->db
            ...
            ->order_by('id', 'DESC') // ambil yang terbaru
            ->get('tb_promo')
            ->row_array();

        // Jika tidak ditemukan promo aktif terbaru
        if (!$promo) {
            echo json_encode([
                'status' => false,
                'message' => 'Promo tidak aktif atau tidak ditemukan.'
            ]);
            return;
        }
